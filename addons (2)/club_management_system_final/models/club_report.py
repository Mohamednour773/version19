...
class ClubReportCash(models.Model):
    ...
    package_name = fields.Char(string='Package / Service', readonly=True)
    ...
    def init(self):
        ...
        self.env.cr.execute("""
            ...
            SELECT
                ROW_NUMBER() OVER (ORDER BY source, ref_id) AS id,
                reference,
                payment_reference,
                package_name,
                source,
            ...
            FROM (
                ...
                SELECT
                    m.id                                    AS ref_id,
                    m.name                                  AS reference,
                    m.payment_reference                     AS payment_reference,
                    p.name                                  AS package_name,
                    'membership'::varchar                   AS source,
                ...
                LEFT JOIN club_package p ON p.id = m.package_id
                ...
                SELECT
                    ...
                    f.name                                  AS package_name,
                    'rental'::varchar                       AS source,
                ...
                LEFT JOIN club_facility f ON f.id = r.facility_id
