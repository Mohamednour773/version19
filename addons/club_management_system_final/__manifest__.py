# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'security/club_feature_security.xml',
        'security/record_rules.xml',
        # Data
        'data/club_data.xml',
        'data/club_notification_data.xml',
        # Views
        ...
        'views/club_membership_feature_views.xml',
        'views/club_class_views.xml',
        'views/club_session_views.xml',
        'views/club_session_feature_views.xml',
        'views/club_attendance_views.xml',
        'views/club_rental_views.xml',
        'views/res_partner_views.xml',
        'views/res_partner_schedule_views.xml',
        'views/club_report_views.xml',
        'views/club_report_overdue_views.xml',
        'views/club_report_dashboard_views.xml',
        'views/club_waitlist_views.xml',
        'views/club_notification_views.xml',
        'views/club_menus.xml',
        'views/club_mobile_attendance_views.xml',
        # Wizards
    ...
    'assets': {
        'web.assets_backend': [
            'club_management_system_final/static/src/css/club_report_dashboard.css',
            'club_management_system_final/static/src/js/club_report_dashboard.js',
            'club_management_system_final/static/src/xml/club_report_dashboard.xml',
        ],
    },
    'installable': True,
    'application': True,
